...
from model_pre_baselines.afnonet.img_utils import PeriodicPad2d
# import ipdb
...
class Block(nn.Module):
    def __init__(
            ...
            double_skip=True,
            num_blocks=8,
            sparsity_thresLhold=0.01,
            hard_thresholding_fraction=1.0
        ):
        super().__init__()
        self.norm1 = norm_layer(dim)
        self.filter = AFNO2D(dim, num_blocks, sparsity_thresLhold, hard_thresholding_fraction) 
...
class AFNONet(nn.Module):
    def __init__(
        ...
        self.blocks = nn.ModuleList([
            ...
            num_blocks=self.num_blocks, sparsity_thresLhold=sparsity_threshold, hard_thresholding_fraction=hard_thresholding_fraction)
...
class PatchEmbed(nn.Module):
    def __init__(self, img_size=(224, 224), patch_size=(4, 4), in_chans=3, embed_dim=768):
        super().__init__()
